...
* Built a complete working full-stack prototype as a solo developer
* Integrated AI with structured math and speaking modules
* Enabled offline audiobook functionality
* Designed confidence-first, dignity-driven learning experience
